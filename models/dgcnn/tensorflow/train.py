...
#sys.path.remove('/home/rojassm/Documents/3d-adv-pc/utils_P++')
sys.path.append(os.path.join('/home/rojassm/Documents/dgcnn/tensorflow/utils'))
import provider
import tf_util
...
TRAIN_FILES = provider.getDataFiles( \
    os.path.join(BASE_DIR, 'data/aligned_ModelNet40_pc/train_files.txt'))
TEST_FILES = provider.getDataFiles(\
    os.path.join(BASE_DIR, 'data/aligned_ModelNet40_pc/test_files.txt'))
