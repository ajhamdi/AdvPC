import os
import sys
#sys.path.remove('/home/rojassm/Documents/3d-adv-pc/utils')
...
def get_model(point_cloud, is_training, bn_decay=None):
    ...
    l2_xyz, l2_points, l2_indices = pointnet_sa_module(l0_xyz, l0_points, npoint=128, radius=0.4, nsample=64, mlp=[128,128,256], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer2')
