...
class AutoEncoder(Neural_Net):
    ...
    def __init__(self, name, graph, configuration):
        ...
        in_shape = [configuration.batch_size] + self.n_input
        out_shape = [configuration.batch_size] + self.n_output
    ...
    # def reconstruct_wthout_compute(self, X):
    #     '''Use AE to reconstruct given data and return tf.variable .'''
    #     return (self.x_reconstr , feed_dict={self.x: X, self.gt: None})
